...
Menu.prototype =
  {
    ...
    create: function () {
      //adds background
      menuBG = game.add.image(0, 0, 'loadBackground');

      //Hide mouse cursor
      document.body.style.cursor = 'none';

      //adds menu text
      var menuTitle = game.add.text(300, 250, 'Alien Invasion',
        { font: '100px Aldrich', fill: '#ffffff' });
      menuTitle.stroke = '#000000';
      menuTitle.strokeThickness = 12;

      //adds button to press
      button = game.add.button(550, 400, 'button', this.actionOnClick, this, 1, 0, 2);
    ...
    actionOnClick: function () {
      ...
      game.time.events.add(Phaser.Timer.SECOND * 1, startPlay, this);
    },
  };
...
Lose.prototype =
  {
    ...
    create: function () {
      //adds background
      loseBG = game.add.image(0, 0, 'loadBackground');
      playMusic.stop();
      ...
      //adds menu text
      var loseTitle = game.add.text(570, 250, 'You Lost',
...
Win.prototype =
  {
    ...
    create: function () {
      //adds background
      winBG = game.add.image(0, 0, 'loadBackground');
